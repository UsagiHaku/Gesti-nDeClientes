                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('clients')}}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="name" required="El nombre es requerido" value="{{ old('name') }}">
                            ...
                            <div class="form-group{{ $errors->has('addres') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="address" required="La dirección es requerida" value="{{ old('address') }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-btn fa-user"></i>Crear cliente
                                    </button>
                                </div>
                            </div>
                        </form>
